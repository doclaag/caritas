...
return [
    ...
    | defecto usados por la clase de validación. Algunas de estas reglas
    ...
    */
    ...
    | personalizada para una regla de atributo en particular.
    |
    */
    ...
    | nuestro marcador de posición de atributo por algo más fácil de leer,
    | como "Dirección de Correo Electrónico" en lugar de "email". Esto
    | simplemente nos ayuda a hacer que nuestro mensaje sea un poco más
    | claro.
    |
    */
